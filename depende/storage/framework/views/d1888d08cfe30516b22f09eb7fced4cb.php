                    ...
                    <div class="container-fluid">
                      ...
                      <div class="collapse navbar-collapse d-flex flex-lg-row-reverse" id="navbarNavAltMarkup">
                        <div class="navbar-nav">
                            ...
                            <button class="resv">
                                <a href="<?php echo e(route('login')); ?>">Reservas</a>
                            </button>
                            <button class="profile">
                                <a href="<?php echo e(route('register')); ?>"><i class="fa-solid fa-user"></i></a>
                            </button>
                        </div>
                      </div>
                    </div>
...
<?php /**PATH C:\Users\user\Documents\depende\resources\views/welcome.blade.php ENDPATH**/ ?>