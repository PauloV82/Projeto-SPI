...
<body class="body">
    <div class="container contt">
        ...
        <div class="back-gradient row justify-content-center">
            <div class="col-12 bgHome">
                <nav class="navbar navbar-expand-lg navbar-dark fs-4 mt-2">
                    <div class="container-fluid">
                      <a class="navbar-brand fs-3" href="/dashboard">home</a>
            ...
            <div class="back-ttl row mt-4">
            <div class="col-12 text-center">
                <h2 class="title-container">@yield('title-section')</h2>
                <div class="progress mx-5 px-5 mt-4" style="height: 2px; background-color:rgb(26, 38, 52);">
